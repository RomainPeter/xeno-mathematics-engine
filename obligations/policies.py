...
class PolicyEngine:
    ...
    def _run_pytest(self, context: Dict[str, Any], obligation: Dict[str, Any]) -> Tuple[Proof, VJustification]:
    ...
    def _run_ruff(self, context: Dict[str, Any], obligation: Dict[str, Any]) -> Tuple[Proof, VJustification]:
    ...
    def _run_mypy(self, context: Dict[str, Any], obligation: Dict[str, Any]) -> Tuple[Proof, VJustification]:
    ...
    def _check_forbidden_imports(self, context: Dict[str, Any], obligation: Dict[str, Any]) -> Tuple[Proof, VJustification]:
    ...
    def _check_cyclomatic_complexity(self, context: Dict[str, Any], obligation: Dict[str, Any]) -> Tuple[Proof, VJustification]:
    ...
    def _check_docstring(self, context: Dict[str, Any], obligation: Dict[str, Any]) -> Tuple[Proof, VJustification]:
        ...
        try:
            ...
            logs = f"Fonctions sans docstring: {missing_docstrings}" if missing_docstrings else "Toutes les fonctions ont une docstring"
    ...
    def _check_type_hints(self, context: Dict[str, Any], obligation: Dict[str, Any]) -> Tuple[Proof, VJustification]:
        ...
        try:
            ...
            logs = f"Fonctions sans annotations: {missing_hints}" if missing_hints else "Toutes les fonctions ont des annotations"
    ...
    def _check_pure_function(self, context: Dict[str, Any], obligation: Dict[str, Any]) -> Tuple[Proof, VJustification]:
    ...
    def _calculate_cyclomatic_complexity(self, code: str) -> int:
        ...
        control_structures = [
            ...
            'with', 'and', 'or', 'assert', 'break', 'continue', 'return'
        ]
