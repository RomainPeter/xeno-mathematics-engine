...
class Selector:
    def __init__(self, bandit, diversity, ids_lambda=None, cvar_alpha=None, overrides_file=None):
        self.bandit = bandit
        ...
        if overrides_file and Path(overrides_file).exists():
            with open(overrides_file) as f:
                ...
                cvar_alpha = overrides.get("risk_policy", {}).get("cvar_alpha", cvar_alpha)
    ...
    def get_scores(self, candidates):
        ...
        for c in candidates:
            ...
            cvar_score = risk_adjusted_utility(reward_samples, cost_samples, alpha=self.cvar_alpha)
