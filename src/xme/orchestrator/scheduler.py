...
class DiscoveryScheduler:
    ...
    async def run_discovery(
        ...
        log_action(store, action="discovery_start", level="S0",
        ...
        for turn in range(self.config.turns):
            ...
            # Log de la sélection
            log_action(store, action="discovery_select", level="S0",
            ...
            log_action(store, action="discovery_reward", level="S0",
                      obligations={"arm": selected_arm, "reward": str(reward)})
        
        # Log de fin
        log_action(store, action="discovery_done", level="S0",
