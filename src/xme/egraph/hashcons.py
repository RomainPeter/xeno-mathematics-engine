...
class HashCons:
    ...
    def _canonical_key(self, node: Dict[str, Any]) -> str:
        ...
        key_data = {"op": op, "args": args_sorted, "attrs": attrs_sorted}
...
def build_egraph_from_expr(
    expr: Dict[str, Any], egraph: Optional[EGraph] = None
) -> Tuple[EGraph, NodeId]:
    """
    ...
    def _build(expr):
        ...
        # Créer le nœud
        node = {"op": op, "args": arg_ids, "attrs": attrs}
