...
class Atom(Node):
    ...
    def __init__(self, symbol: str, attrs: Optional[Dict[str, Any]] = None):
        super().__init__(op="atom", args=[], attrs={"symbol": symbol, **(attrs or {})})
...
class Value(Node):
    ...
    def __init__(self, value: Union[int, float, str], attrs: Optional[Dict[str, Any]] = None):
        super().__init__(op="value", args=[], attrs={"value": value, **(attrs or {})})
...
class Variable(Node):
    ...
    def __init__(self, name: str, attrs: Optional[Dict[str, Any]] = None):
        super().__init__(op="var", args=[], attrs={"name": name, **(attrs or {})})
...
def alpha_rename_expr(
    expr: Dict[str, Any], renamer: Optional[AlphaRenamer] = None
) -> Dict[str, Any]:
    """
    ...
    if "var" in expr:
        ...
        return {"var": new_name, **{k: v for k, v in expr.items() if k not in ("var")}}
