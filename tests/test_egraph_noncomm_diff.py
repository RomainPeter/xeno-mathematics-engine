...
def test_division_order_matters():
    ...
    expr1 = {
        "op": "/",
        "args": [{"op": "value", "attrs": {"value": 10}}, {"op": "value", "attrs": {"value": 2}}],
    }

    expr2 = {
        "op": "/",
        "args": [{"op": "value", "attrs": {"value": 2}}, {"op": "value", "attrs": {"value": 10}}],
    }
...
def test_mixed_commutative_non_commutative():
    ...
    expr1 = {
        "op": "+",
        "args": [
            {"op": "compose", "args": [{"op": "var", "name": "f"}, {"op": "var", "name": "g"}]},
            {"op": "compose", "args": [{"op": "var", "name": "h"}, {"op": "var", "name": "i"}]},
        ],
    }
