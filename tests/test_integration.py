...
import tempfile
import os
from proofengine.core.schemas import XState, VJustification, Proof, PCAP
    ...
    def test_metrics_collector_integration(self):
        ...
        pcaps = [
            ...
            PCAP(
                ...
                justification=VJustification(time_ms=200, retries=1, backtracks=0, audit_cost=2.0, risk=0.2, tech_debt=1),
                proofs=[],
                verdict="fail",
                toolchain={},
                pcap_hash="hash2"
