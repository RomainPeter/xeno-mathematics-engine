...
import pytest
from proofengine.core.schemas import VJustification, Proof, PCAP, XState, ActionVariant
...
class TestVCost:
    ...
    def test_vcost_to_dict(self):
        ...
        cost = VJustification(time_ms=50, retries=1, backtracks=0, audit_cost=0.8, risk=0.2, tech_debt=1)
...
class TestHashing:
    ...
    def test_hash_pcap(self):
        ...
        pcap = PCAP(
            ...
            justification=VJustification(time_ms=100, retries=0, backtracks=0, audit_cost=1.0, risk=0.1, tech_debt=0),
            proofs=[],
            verdict="pass",
...
class TestStateManager:
    ...
    def test_add_rule_from_incident(self):
        ...
        incident_pcap = PCAP(
            ...
            post_hash="post",
            obligations=["test_obligation"],
            justification=VJustification(time_ms=100, retries=1, backtracks=0, audit_cost=2.0, risk=0.8, tech_debt=1),
            proofs=[],
            verdict="fail",
            toolchain={},
