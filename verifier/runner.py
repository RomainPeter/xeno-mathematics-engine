...
def verify_obligations_compliance(pcap: PCAP) -> Dict[str, Any]:
    ...
    for obligation in pcap.obligations:
        if obligation in ["tests_ok", "lint_ok", "types_ok", "security_ok", "complexity_ok", "docstring_ok"]:
    ...
    if compliance["obligations_checked"] > 0:
        compliance["compliance_rate"] = 1.0 - (len(compliance["violations"]) / compliance["obligations_checked"])
